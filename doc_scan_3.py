...
img_warp = crop_and_warp(img, corners)
square = infer_grid(img_warp)
print(np.shape(square))
print(square[0])
tile = cut_from_rect(img_warp, square[0])


show_image(tile)


#  https://github.com/aakashjhawar/SolveSudoku/blob/master/SudokuExtractor.py
